...
namespace PMS.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Contact,Speciality,Credentials,DepartmentId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Contact,Speciality,Credentials,DepartmentId")] Doctor doctor)
        {
            if (id != doctor.Id)
            {
                return NotFound();
